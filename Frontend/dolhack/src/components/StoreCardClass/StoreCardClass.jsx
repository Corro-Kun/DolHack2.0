        ...
        <div className="StoreCardClass-render" >
            {
                classList.map((clas, index) => (
                    <CardClass key={clas.idclase} foto={clas.foto} imagen={clas.imagen} title={clas.titulo} description={clas.descripcion} tipo={clas.nombretipo} nivel={clas.nombrenivel} />
                ))
            }
        </div>
    );
