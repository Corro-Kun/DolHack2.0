...
public class ModelClase {
    ...
    public ModelClase(String idclase, String titulo, String descripcion, String fecha_inicio, String fecha_finalizacion, String usuario_idusuario, int lista_idlista, int tipo_idtipo, int nivel_idnivel, String imagen){
